...
namespace Consola
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Comparar(primerTexto, segundoTexto, (str1, str2) => str1.Split(" ").Length - str2.Split(" ").Length);
        ...
        private static void Comparar(string str1, string str2, Func<string, string , int> criterio)
        {
            int resultado = criterio(str1, str2);
            if (resultado > 0)
            {
                Console.WriteLine("El primer texto es mas grande que el segundo");
            }else if (resultado < 0)
            {
                Console.WriteLine("El primer texto es mas chico que el segundo");
            }
            else
            {
